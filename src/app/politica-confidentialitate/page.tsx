    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        ...
        <div className="prose prose-sm text-gray-700 space-y-4">
          <p>Autoritatea Electorală Permanentă (AEP) prelucrează datele cu caracter personal ale utilizatorilor platformei AEP Instruire Online în conformitate cu Regulamentul (UE) 2016/679 (GDPR) și legislația națională aplicabilă.</p>
